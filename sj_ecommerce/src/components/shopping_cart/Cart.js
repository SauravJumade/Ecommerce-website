            ...
            <div className='cart_section'>
                <div className='cart_container'>
                    ...
                    <div className='right_cart'>
                        <h3>Fitness Gear</h3>
                        <h4>Pigeaon FAVOURITE Electric Kettle (1.5 L , Silver , Black)</h4>
                        <Divider />
                        ...
                        <p className='description'>About the Item :<span style={{ color: "#565959", fontSize: 14, fontWeight: 500, letterSpacing: 0.4 }}>
